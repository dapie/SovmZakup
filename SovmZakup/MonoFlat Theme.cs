...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        public MonoFlat_ThemeContainer()
        {
            ...
            BackColor = Color.FromArgb(174, 146, 118);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(174, 146, 118)), new Rectangle(0, 0, Width, 60));
    ...
    public class MonoFlat_Button : Control
    {
        ...
        public MonoFlat_Button()
        {
            ...
            P1 = new Pen(Color.FromArgb(174, 146, 118)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(174, 146, 118)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(174, 146, 118), Color.FromArgb(174, 146, 118), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(169, 141, 113), Color.FromArgb(174, 146, 118), 90.0F);
            }

            Shape.AddArc(0, 0, 4, 4, 180, 90);
            Shape.AddArc(Width - 5, 0, 4, 4, -90, 90);
            Shape.AddArc(Width - 5, Height - 5, 4, 4, 0, 90);
            Shape.AddArc(0, Height - 5, 4, 4, 90, 90);
    ...
    public class MonoFlat_MenuButton : Control
    {
        ...
        public MonoFlat_MenuButton()
        {
            ...
            ForeColor = Color.FromArgb(51,77,110);
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(255, 255, 255)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(255, 255, 255)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                Shape = new GraphicsPath();
                R1 = new Rectangle(0, 0, Width, Height);
                R2 = new Rectangle(63, 4, Width-63, Height-4);
                if (_IsActive) ForeColor = Color.FromArgb(174, 146, 118);
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(255,255,255), Color.FromArgb(255,255,255), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(244, 249, 255), Color.FromArgb(244, 249, 255), 90.0F);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (MouseState)
            {
                case 0:
                    ...
                    {
                        Color textColor;
                        if (_IsActive) textColor = Color.FromArgb(174, 146, 118);
                        else textColor = ForeColor;
                        G.DrawImage(_Image, ipt.X+27, ipt.Y, ImageSize.Width, ImageSize.Height);
                        G.DrawString(Text, Font, new SolidBrush(textColor), R2, new StringFormat
                        {
                ...
                case 1:
                    ...
                    else
                    {
                        ...
                        G.DrawImage(_Image, ipt.X+27, ipt.Y, ImageSize.Width, ImageSize.Height);
                        G.DrawString(Text, Font, new SolidBrush(ForeColor), R2, new StringFormat
                        {
                            Alignment = StringAlignment.Near,
                            LineAlignment = StringAlignment.Center
                        });
